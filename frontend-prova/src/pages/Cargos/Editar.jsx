...
export default function EditarCargo() {
  ...
  if (carregando) return <div className="p-8 text-center text-gray-500">Carregando dados do cargo...</div>;

  return (
    <div className="w-full max-w-4xl mx-auto pb-10 flex flex-col relative">
      <div className="mb-6">
        <h1 className="text-4xl font-bold text-[#3078b4] mb-1">Editar Cargo</h1>
        <p className="text-gray-500 text-sm">Altere as informações deste cargo</p>
      </div>
