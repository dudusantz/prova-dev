...
export default function NovoDepartamento() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto pb-10 flex flex-col relative">
      <div className="mb-6">
        <h1 className="text-4xl font-bold text-azul-base mb-1">Cadastro de Departamento</h1>
        <p className="text-corpo text-sm">Adicione as informações do novo departamento</p>
      </div>
