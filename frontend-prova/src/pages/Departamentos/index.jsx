  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-4xl font-bold text-azul-base mb-1">Departamentos</h1>
            ...
            <tbody>
              {carregando ? (
                ...
                departamentos.map((depto) => (
                  <tr key={depto.id} className="border-t border-outline hover:bg-fundo-2 transition-colors">
