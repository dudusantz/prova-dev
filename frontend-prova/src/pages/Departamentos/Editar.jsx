...
export default function EditarDepartamento() {
  ...
  if (carregando) return <div className="p-8 text-center text-corpo">Carregando dados do departamento...</div>;

  return (
    <div className="w-full max-w-4xl mx-auto pb-10 flex flex-col relative">
      <div className="mb-6">
        <h1 className="text-4xl font-bold text-azul-base mb-1">Editar Departamento</h1>
